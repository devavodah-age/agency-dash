    ...
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', background:'#060606', padding:'24px' }}>
      <div style={{ width:'100%', maxWidth:'380px' }}>
        <div style={{ textAlign:'center', marginBottom:'40px' }}>
          ...
          <h2 style={{ fontSize:'24px', fontWeight:700, color:'white', marginBottom:'8px' }}>Portal do Cliente</h2>
          <p style={{ fontSize:'13px', color:'rgba(255,255,255,0.32)' }}>Acesse suas métricas e suporte</p>
        </div>
